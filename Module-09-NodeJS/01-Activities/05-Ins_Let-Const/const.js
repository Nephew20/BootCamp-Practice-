...
// once it is set it can't be changed later on
// const age = 25;
...
//const does not mean a set value for arrays (maybe obj too) you can add stuff inside but not change the box aswell 
